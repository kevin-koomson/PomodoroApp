...
const timerData = {
    ...
    pomoMode() {
        ...
        pageMinutes.innerHTML = numDisp(this.minute);
        pageSeconds.innerHTML = numDisp(this.second);
        pauser.classList.add('hidden');
        resumer.classList.add('hidden');
    ...
    longBreakMode() {
        ...
        pageMinutes.innerHTML = numDisp(this.longBreak.minutes);
        pageSeconds.innerHTML = numDisp(this.longBreak.seconds);
        progressBar.style.background = `conic-gradient(${this.activeColor} 360deg,#161932 0deg)`;
        pauser.classList.add('hidden');
        resumer.classList.add('hidden');
